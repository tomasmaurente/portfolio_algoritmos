...
public class TArbolTrie implements IArbolTrie {
    ...
    public int insertarComparaciones(String palabra) {
        if (raiz == null) {
            raiz = new TNodoTrie();
        }
        return raiz.insertarComparaciones(palabra);
    }
    ...
    public int getAltura(){
        if (raiz != null){
            return this.raiz.getAltura(raiz) - 1;
        } else {
            return 0;
        }
    }
    ...
    public int getTamano(){
        if (raiz != null){
            return this.raiz.getTamaño(raiz) - 1 ;
        } else {
            return 0;
        }
    }
